...
//			@Override
//			public void run() {
//				MiuiRepoPageProcessor miuiRepoPageProcessor = new MiuiRepoPageProcessor("综艺 娱乐");
...
//				MiuiRepoPageProcessor miuiRepoPageProcessor = new MiuiRepoPageProcessor("电影解说 恐怖",url);
//				Spider miuispider = Spider.create(miuiRepoPageProcessor);
//				miuispider.setDownloader(new SeleniumChromeDownloader());
//				miuispider.addPipeline(elastrcsearchPipeline);
////				addPipeline(new JsonFilePipeline("E:\\tempdata\\"))
...
//		}).start();
		...
		new Thread(new Runnable() {
			...
			public void run() {
				//50
				NanGuaRepoPageProcessor nanGuaRepoPageProcessor = new NanGuaRepoPageProcessor(50,50);
