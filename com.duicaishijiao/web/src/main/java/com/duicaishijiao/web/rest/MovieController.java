...
import com.duicaishijiao.web.vo.CommentPut;
...
public class MovieController {
	...
	@PutMapping("share")
	public void share(HttpServletRequest request , @RequestHeader("User-Agent") String device,@RequestBody SharePut sharePut) {
		sharePut.setDevice(device);
		sharePut.setIp(request.getRemoteAddr());
